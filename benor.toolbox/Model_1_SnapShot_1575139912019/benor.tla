...
4. MINORITY REPORT
    ...
    c. Observations - In all of the above inputs, '0' is in the minority quorum. 
                      When we ran the model with the above inputs, MinorityReport was not violated.
                      This establishes that a value from the minority quorum will never be anchored.
